<section>
    <div class="flex justify-end mr-6 pb-4">
        <a href="/posts/create" class="text-indigo-500 hover:text-indigo-700">
            Create</a>
    </div>
            ...
            <tbody>
                ...
                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                    ...
                    <td class="px-6 py-4 space-x-2">
                        ...
                        <button wire:click="deletePost({{ $post->id }})"  wire:confirm="Are you sure you want to delete this post?" class="font-medium text-red-600 dark:text-blue-500 hover:underline">
                            Delete
                        </button>
                    </td>
                </tr>
