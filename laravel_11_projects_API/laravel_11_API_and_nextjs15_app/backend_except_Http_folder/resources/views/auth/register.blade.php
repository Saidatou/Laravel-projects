 ...
 <form method="POST" action="{{ route('register') }}" class="my-4">
    ...
    <div class="form-group mb-3">
     ...
     <div class="form-group mb-3">
        ...
        <input class="form-control"  name="password_confirmation" type="password" id="password_confirmation" placeholder="Enter your password">
    </div>
    ...
    <div class="form-group mb-0 row">
        ...
        <div class="text-center text-muted mb-4">
            <p class="mb-0">You have an account ?<a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'>Sing in</a></p>
        </div>
